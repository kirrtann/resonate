...
export default function Blogpost() {
    return (<>
        <div className="bg-[#17312F] box-border pt-[5rem] px-5  text-white select-none font-[DM-sans,sans]">

            <div className="container mx-auto">

                <div className="flex flex-col max-w-[70rem] mx-auto">
                    <div className="">
                        <div className=" lg:max-w-[47rem]  min-w-[auto] lg:min-w-[47rem]  ">
                            <div className="">
                                <p className="">Motion Design
                                </p>
                                <h1 className="sm:text-[48px] text-[30px]  ">Using Motion Design for Social Media Marketing</h1>
                            </div>
                            <div className="grid sm:grid-cols-3 sm:w-fit sm:gap-6 md:gap-12 sm:place-items-center text-[12px] ">
                                <div className="flex place-items-center gap-2" ><img className="w-[30px] mt- rounded-full mb-2 " src="https://cdn.prod.website-files.com/66e9c11534c3c55b4c45a063/66e9c11534c3c55b4c45a069_alex.png" alt="" />PETE SENA</div>

                                <div className="border-y sm:border-y-0 sm:py-0 py-3 border-[#eef1ea1a] sm:px-4  sm:border-x ">oct 20 2020</div>

                                <div className="sm:py-0 sm:px-4 py-3">10 MIN READ</div>
                            </div>
                        </div></div>
                    {/* <div className="grid lg:grid-cols-2   mt-3 sm:mt-10 bg-red-500 mx-auto"> */}
                    <div className="flex  mt-3 sm:mt-10 ">
                        <div><img className="rounded-2xl w-[90%] sm:w-full " src="https://cdn.prod.website-files.com/66e9c11534c3c55b4c45a063/66e9dec00457dd623916ef40_Thumbnail-p-800.png" alt="" />
                            <div className="sm:pt-10  ">
                                <h2 className="sm:text-[40px] text-[25px] mt-[32px] mb-2">Introduction to Motion Design in Social Media</h2>
                                ...
                                <h2 className="sm:text-[40px] text-[25px] mt-[32px]">Creating Engaging Content</h2>
                                ...
                                <h2 className="sm:text-[40px] text-[25px] mt-[32px]">Best Practices for Social Media Motion Design</h2>
                                ...
                                <h2 className="sm:text-[40px] text-[25px] mt-[32px]">Conclusion  </h2>
                                ...
                                <div className="uppercase text-[#CBFF54] border-t border-b mt-5 py-10 border-[#eef1ea1a] flex place-content-center ">
                                    ...
                                    <div className="place-content-center text-[12px]">
                                        <ul className="grid sm:grid-cols-4 grid-cols-2  sm:space-x-2 " >
                                ...
                                <div>
                                    <div className="text-[#CBFF54] py-5 uppercase text-[12px]">more Like this</div>
                                    <div className="sm:flex  sm:space-y-0 space-y-4 sm:space-x-5 ">
                                        <Card
